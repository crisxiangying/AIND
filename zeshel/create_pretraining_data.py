...
def create_training_instances(input_file, tokenizer, max_seq_length, rng):
  ...
  with tf.gfile.GFile(input_file, "r") as reader:
    while True:
      ...
      # line = json.loads(line)['description'] #cxy 源代码只取data中text字段
      line = json.loads(line)['text'] # cxy 只取paper metion文件中的text字段
      # line = json.loads(line)['assigneeexample']['name']
  ...
  instances = create_instances_from_document(
            document, max_seq_length, vocab_words, rng)
...
def main(_):
  ...
  # input_file = "/home/cxy/process_wikidump/linkedin_pretrain_data.jsonl"
  input_file = "/home/cxy/bert/data/wiki/expandNIL_putcasback/traindata/train_mentions.json"
  output_file = '/home/cxy/bert/data/zeshel/pretrain_linkedin/paper_pretraindata.tfrecord'
  ...
  write_instance_to_example_files(
      instances, tokenizer, FLAGS.max_seq_length, output_file)
