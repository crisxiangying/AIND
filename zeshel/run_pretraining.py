  ...
  with tf.variable_scope("cls/predictions"):
    ...
    with tf.variable_scope("transform"):
      input_tensor = tf.layers.dense(
          ...
          activation=bertbase.modeling.get_activation(bert_config.hidden_act),
          kernel_initializer=bertbase.modeling.create_initializer(
              bert_config.initializer_range))
      input_tensor = bertbase.modeling.layer_norm(input_tensor)
